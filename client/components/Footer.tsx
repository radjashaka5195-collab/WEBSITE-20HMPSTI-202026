import { ArrowRight, Star as StarIcon, Terminal, Instagram, Linkedin, ChevronDown, Quote, Target, Users, Heart, Trophy, Lightbulb } from "lucide-react";
...
export default function Home() {
  ...
  // NAVIGASI FOOTER DIHAPUS SUPAYA TIDAK MUNCUL DI HALAMAN
  // const footerLinks = [ ... ]; // SUDAH DIHAPUS
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-[#33A5D3] selection:text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-20 pb-10 overflow-hidden">
        ...
        <motion.div style={{ y }} className="relative z-10 text-center max-w-5xl mx-auto flex flex-col items-center">
          ...
          {/* TOMBOL NAVIGASI DI HERO JUGA SAYA SEMBUNYIKAN BIAR GA BISA DIKLIK */}
          {/* <FadeIn delay={0.6}>
      ...
      {/* --- FOOTER (VERSI BERSIH - TANPA NAVIGASI) --- */}
