...
export default function Index() {
  ...
  const evaluationPoints = [
    {
      ...
      description: "Sistem penilaian pengurus saat ini terlalu fokus pada karakter personal bukannya berdasarkan KPI sehingga rentan terjadinya ketidakadilan karena faktor kedekatan pertemanan",
      color: "bg-primary"
    },
    {
      number: "02",
      title: "Himpunan minim adanya kegiatan pembinaan rutin",
      description: "untuk meningkatkan soft skill dan hard skill yang manfaatnya sangat dirasakan mahasiswa teknologi informasi",
      color: "bg-secondary",
    },
    {
      number: "03",
      title: "Penampungan aspirasi mahasiswa TI kurang menyebar.",
      description: "Wadah aspirasi mahasiswa saat ini hanya menjadi formalitas tanpa adanya tindak lanjut yang transparan dan solutif",
      color: "bg-primary"
    },
    {
      number: "04",
      title: "Penempatan program pelatihan yang tidak sesuai dengan fungsi utama departemennya.",
      description: "Contohnya berani bicara di departemen perhubungan yang seharusnya ada di departemen psdm. Perhubungan seharusnya hanya berfokus pada eksternal saja",
      color: "bg-secondary"
    }
  ];
  ...
  const missions = [
    ...
    {
      number: "04",
      title: "Meningkatkan kualitas mahasiswa melalui program pengembangan, guna meningkatkan Hard Skill dan Soft Skill mahasiswa untuk mencetak segudang Prestasi",
      color: "bg-secondary"
    },
    {
      number: "05",
            ...
            {evaluationPoints.map((point, idx) => (
              <div key={idx} className="group">
                <div className="flex gap-6 items-start">
                  <div className={`${point.color} w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center flex-shrink-0 font-black text-lg sm:text-2xl text-black group-hover:scale-110 transition transform`}>
                    {point.number}
                  </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-white/80 leading-relaxed text-lg">
                    diambil dari kata innovation atau inovasi yang berarti menciptakan hal baru yang beda dari sebelumnya
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-white/80 leading-relaxed text-lg">
                    diambil dari kata era atau zaman. zaman yang dimana aspirasi didengar, Kolaborasi yang terbuka dan Prestasi terbentuk melalui pembinaan yang ada
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 px-4 py-8 bg-white/5 rounded-xl border border-white/10">
            <p className="text-center text-white/80 text-lg leading-relaxed">
              Kami berkomitmen untuk membangun <span className="text-primary font-bold">Himpunan Mahasiswa Teknologi Informasi</span> sebagai <span className="text-primary font-bold">Rumah Kolaborasi</span> yang menciptakan <span className="text-primary font-bold">Inovasi</span> untuk mewujudkan <span className="text-primary font-bold">Prestasi</span>
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-white/80 text-xl leading-relaxed">
                Mewujudkan <span className="text-primary font-bold">Himpunan Mahasiswa Teknologi Informasi</span> sebagai <span className="text-primary font-bold">Rumah Kolaborasi</span> yang menciptakan <span className="text-primary font-bold">Inovasi</span> untuk mewujudkan <span className="text-primary font-bold">Prestasi</span>
              </p>
            </div>
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
              {missions.map((mission, idx) => (
                <div key={idx} className="group">
                  <div className={`${mission.color} w-20 h-20 rounded-full flex items-center justify-center font-black text-2xl text-black mb-6 group-hover:scale-110 transition transform`}>
                    {mission.number}
                  </div>
            ...
            <div>
              ...
              <div className="bg-white/5 border border-primary/30 rounded-xl p-6">
                ...
                <p className="text-white/80 leading-relaxed">
                  Terwujudnya peningkatan kualitas <span className="text-primary font-bold">Soft skill dan Hard Skill</span> mahasiswa TI, sehingga melahirkan SDM yang berkompeten dan siap bersaing
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/60">
                <li><a href="#filosofi" className="hover:text-primary transition">Filosofi</a></li>
                <li><a href="#visi-misi" className="hover:text-primary transition">Visi & Misi</a></li>
                <li><a href="#program" className="hover:text-primary transition">Program</a></li>
                <li><a href="#departemen" className="hover:text-primary transition">Departemen</a></li>
              </ul>
            </div>
            <div>
